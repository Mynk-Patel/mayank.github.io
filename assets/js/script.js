...
const portfolioOverlay = document.querySelector("[data-overlay-portfolio]");
...
portfolioItems.forEach((item) => {
  item.addEventListener("click", function () {
    // Get dynamic content from the clicked project
    const projectImg = this.dataset.portfolioImg;
    const projectTitle = this.dataset.portfolioTitle;
    const projectText = this.dataset.portfolioText;
    const projectLink = this.dataset.portfolioLink;

    // Update the modal content
    portfolioModalImg.src = projectImg;
    portfolioModalImg.alt = projectTitle;
    portfolioModalTitle.innerText = projectTitle;
    portfolioModalText.innerText = projectText;
    portfolioModalLink.href = projectLink;
